...
import { getTvSeries } from '../../services/apiHandler';
            ...
            {data.map((item) => (
                <>
                    <div className={`${classes.glassCss} ${classes.cardCss}`}
                        ...
                        <span className={classes.title}>{item.original_name}</span>
                        <div className={classes.dataContainer}>
                            <span >Aired on:&nbsp;{item.first_air_date}</span>
                            <br />
